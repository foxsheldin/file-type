...
async function _fromTokenizer(tokenizer) {
	...
	if (check([0xD0, 0xCF, 0x11, 0xE0, 0xA1, 0xB1, 0x1A, 0xE1])) {
		...
		await tokenizer.peekBuffer(buffer, { position: 0x2000, length: 20, mayBeLess: true })

		if (checkString('R\x00o\x00o\x00t\x00 \x00E\x00n\x00t\x00r\x00y')) {
			return {
				ext: 'max',
				mime: 'application/octet-stream'
			}
		...
		await tokenizer.peekBuffer(buffer, { position: 0x408E, length: 16, mayBeLess: true })

		if (checkString('A\x00u\x00t\x00o\x00d\x00e\x00s\x00k')) {
			return {
				ext: 'max',
				mime: 'application/octet-stream'
			}
